...
* Constants
*/
var NAME$24 = "autosize";
var EVENT_RESIZED = `resized${`.${`bs.${NAME$24}`}`}`;
...
*/
for (const element of SelectorEngine.find(SELECTOR_DATA_TOGGLE$10)) Autosize.getOrCreateInstance(element);
//#endregion
...
* Constants
*/
var NAME$23 = "confetti";
var EVENT_KEY$16 = `.${`bs.${NAME$23}`}`;
var EVENT_START$1 = `start${EVENT_KEY$16}`;
var EVENT_END = `end${EVENT_KEY$16}`;
var EVENT_CLICK_DATA_API$7 = `click${EVENT_KEY$16}.data-api`;
var CLASS_NAME_CANVAS = `${NAME$23}-canvas`;
var SELECTOR_DATA_TOGGLE$9 = `[data-bs-toggle="${NAME$23}"], [data-tblr-toggle="${NAME$23}"]`;
var PALETTE = [
	["blue", "#066fd1"],
	["azure", "#4299e1"],
	["indigo", "#4263eb"],
...
var DATA_ATTRIBUTE$1 = `data-${NAME$22}`;
var EVENT_START = `start${EVENT_KEY$15}`;
var EVENT_COMPLETE$1 = `complete${EVENT_KEY$15}`;
var DATA_ATTRIBUTE_ALIAS = `data-tblr-${NAME$22}`;
...
* Data API implementation
*/
for (const element of SelectorEngine.find(SELECTOR_DATA_COUNTUP)) CountUp.getOrCreateInstance(element);
//#endregion
...
* Data API implementation
*/
for (const element of SelectorEngine.find(SELECTOR_DATA_MASK)) InputMask.getOrCreateInstance(element);
var bottom = "bottom";
var right = "right";
var left = "left";
var auto = "auto";
...
* Data API implementation
*/
for (const element of SelectorEngine.find(SELECTOR_DATA_TOGGLE$2)) SwitchIcon.getOrCreateInstance(element);
//#endregion
...
* Data API implementation
*/
for (const element of SelectorEngine.find(SELECTOR_DATA_SORTABLE)) Sortable.getOrCreateInstance(element);
//#endregion
...
* Data API implementation
*/
for (const element of SelectorEngine.find(SELECTOR_DATA_TOGGLE$1)) OtpInput.getOrCreateInstance(element);
//#endregion
...
* Data API implementation
*/
for (const element of SelectorEngine.find(SELECTOR_DATA_TOGGLE)) Sparkline.getOrCreateInstance(element);
//#endregion
...
//#endregion
export { Alert, Autosize, Button, Carousel, Collapse, Confetti, CountUp, Dropdown, InputMask, Modal, Offcanvas, OtpInput, Popover, lib_exports as Popper, ScrollSpy, Sortable, Sparkline, Strength, SwitchIcon, Tab, Toast, Tooltip, bootstrap };
